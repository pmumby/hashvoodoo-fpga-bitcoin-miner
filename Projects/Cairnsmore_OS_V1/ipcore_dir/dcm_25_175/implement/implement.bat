...
xst -ifn xst.scr
move dcm_25_175_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm_25_175_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_25_175_exdes.ucf dcm_25_175_exdes

echo 'Running map'
map -timing -pr b dcm_25_175_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm_25_175_exdes -w routed.ncd routed.v
cd ..
